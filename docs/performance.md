...
### **Docker PostgreSQL**
- **📊 [Tiny Dataset](./performance-docker-tiny.md)**: 5 courses, 10 students, 20 enrollments
- **📊 [Small Dataset](./performance-docker-small.md)**: 500 courses, 5,000 students, 25,000 enrollments
- **📊 [Medium Dataset](./performance-docker-medium.md)**: 1,000 courses, 10,000 students, 50,000 enrollments
...
- **📊 [Medium Dataset](./performance-local-medium.md)**: 1,000 courses, 10,000 students, 50,000 enrollments
