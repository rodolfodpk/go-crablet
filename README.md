...
[![Code Coverage](https://img.shields.io/badge/code%20coverage-77.8%25-yellow?logo=go)](https://github.com/rodolfodpk/go-crablet/actions/workflows/coverage.yml)
...
Run any example with: `go run internal/examples/[example-name]/main.go` (or `go run internal/examples/transfer/cmd/main.go` for the transfer example)
